...
class BinarySearch(SortingBase):

    def __init__(self, title="Binary Search", values=None, **kwargs):
...
if __name__ == '__main__':
    ...
    array = BinarySearch(values=[int(arg) for arg in nonneg] if nonneg else None)
