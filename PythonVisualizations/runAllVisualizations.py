...
PREFERRED_ARRANGEMENT = [
    ...
    [
        "Chapters 5-7",
        ["LinkedList", "OrderedList", "TowerOfHanoi", "Mergesort", "AdvancedArraySort"],
    ],
    [
        "Chapters 8-11",
        [
    ...
    [
        "Chapters 12-16",
        ["PointQuadtree", "Heap", "Graph", "WeightedGraph", "BloomFilter", "SkipList"],
    ],
]
    ...
    def mHandler(event):
        ...
        if debug:
            ...
            print(
                ...
                intro.columnconfigure(0),
            )
            print(
                "IntroCenter size =",
                introCenter.winfo_width(),
                "x",
